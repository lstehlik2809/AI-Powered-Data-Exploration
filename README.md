...
🤖 For that purpose I built a simple app consisting of several agent-like components (powered by one of Google's Gemini models), each responsible for a different aspect of the insight-generation process and using inputs from the others:
